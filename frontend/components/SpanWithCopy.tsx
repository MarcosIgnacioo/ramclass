...
export default function SpanWithCopy(data) {
 const clipboard = <svg aria-hidden={true} onClick={(e) => {
  copyToClipBoard(e)
 }} xmlns="http://www.w3.org/2000/svg" width="64" height="27" fill="none" viewBox="3 2 24 24" className="icon-md-heavy clipboard">
